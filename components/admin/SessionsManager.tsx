...
export default function SessionsManager({ accounts, total, page, pageSize, currentUserId }: SessionsManagerProps) {
  return (
    <div>
      <div>
        <h1 className="text-xl font-bold text-foreground">Phiên đăng nhập ({total})</h1>
      ...
      <div className="mt-6 overflow-hidden rounded-xl2 border border-border bg-card shadow-card">
        ...
        <Pagination page={page} pageSize={pageSize} total={total} basePath="/admin/sessions" />
      </div>
    </div>
  );
}
